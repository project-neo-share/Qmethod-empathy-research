...
# -----------------------------
Q_SET = [
    "같은 정보라면, 공감하는 말투는 AI에 대한 신뢰를 높인다.",
    "근거 없이 공감 표현만 반복하면 신뢰가 줄어든다.",
    "정보만 전달하는 중립 말투는 오래 쓰다 보면 신뢰를 쌓기 어렵다.",
    "말투가 상황과 상관없이 들쭉날쭉하면 신뢰가 흔들린다.",
    "작은 실수도 여러 번 반복되면 신뢰가 빨리 줄어든다.",
    "실수 뒤에 사과와 수정 계획을 알려주면 신뢰 회복에 도움이 된다.",
    "내 선호나 과거 대화를 기억하는 AI는 신뢰가 더 빨리 쌓인다.",
    "한계나 불확실성을 솔직히 말하면 과신은 줄고 신뢰는 유지된다.",
    "내가 준 피드백이 다음 답변에 반영되면 신뢰가 높아진다.",
    "출처나 근거를 함께 보여주면 신뢰가 높아진다.",
    "사용자가 말투(공감/중립)를 직접 고를 수 있으면 신뢰가 높아진다.",
    "중요한 결론은 이유를 간단히라도 설명해 주면 수용이 쉬워진다.",
    "이름이나 일정한 페르소나 같은 가벼운 인간적 단서는 신뢰에 도움이 된다.",
    "과한 감정 표현은 부담스럽고 신뢰를 낮출 수 있다.",
    "사람처럼 보이는지보다, 태도와 기준이 일관된지가 더 중요하다.",
    "위험이 큰 일은 사람이 최종 확인하면 더 안심된다.",
    "반복적이고 정형적인 일은 AI에게 맡겨도 괜찮다.",
    "공감이 중요한 일은 사람과 AI가 함께 할 때 성과가 더 좋다.",
    "필요하면 언제든 사람에게 연결되는 절차가 있으면 신뢰가 유지된다.",
    "정확도뿐 아니라 말투의 적절성도 성과 지표에 포함되어야 한다.",
    "편향을 줄이려는 노력과 결과를 공개하면 신뢰가 높아진다.",
    "개인정보는 최소로 쓰고, 감정 관련 데이터는 특히 조심해야 한다.",
    "조직은 작성보다 검토·조율 역할을 더 중요하게 볼 필요가 있다.",
    "공감 커뮤니케이션과 AI 활용법을 함께 훈련하면 협업 성과가 좋아진다.",
    "보상·평가에 정서적 적합성(말투·배려)을 반영하면 채택이 빨라진다.",
    "예측 중심 업무는 기본적으로 AI 위임이 적합하다.",
    "공감 중심 업무는 기본적으로 인간–AI 협업이 적합하다.",
    "고객 응대는 AI가 초안을 만들고 사람이 다듬으면 효율과 만족을 함께 높일 수 있다.",
    "의료 안내는 공감 있는 설명과 사람의 최종 판단이 함께 있을 때 신뢰가 유지된다.",
    "교육 피드백은 AI의 개별화 제안과 교사의 정서 코칭이 결합될 때 효과가 크다."
]
...
with tab1:
    ...
    **소요 시간:** 약 **5–7분** │ **응답 형식:** 5점 리커트(30문항)
    ...
    #### 📝 **참여 안내**
    - 30개 짧은 진술문에 대해 *전혀 동의하지 않음(1) ~ 매우 동의함(5)* 중 하나를 선택해 주세요.  
